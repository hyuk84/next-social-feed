      ...
      <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">@alexc_tech • 5h ago</p>
                </div>
              </div>
              <button className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors">
                <span className="material-symbols-outlined">more_horiz</span>
          ...
          <article className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
            ...
            <div className="px-4 pb-6">
              <p className="text-slate-800 dark:text-slate-200 leading-relaxed text-lg">
                ...
                why the code you just wrote isn't working the way you thought it
                would.
                <br />
                <br />
        ...
        <aside className="hidden xl:block w-80 space-y-6 flex-shrink-0">
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="group cursor-pointer">
                <p className="text-xs text-slate-500">Trending in Technology</p>
              ...
              <div className="group cursor-pointer">
                <p className="text-xs text-slate-500">Trending in World News</p>
                <p className="font-bold text-sm group-hover:text-primary transition-colors">
                  SustainableEnergy
                </p>
              ...
              <div className="group cursor-pointer">
                <p className="text-xs text-slate-500">Trending in Lifestyle</p>
                <p className="font-bold text-sm group-hover:text-primary transition-colors">
                  #MinimalismChallenge
                </p>
          ...
          <footer className="px-4 text-xs text-slate-400 space-x-2">
            ...
            <div className="mt-2 text-slate-500">© 2024 SocialSphere Inc.</div>
          </footer>
        </aside>
      </div>
    </main>
